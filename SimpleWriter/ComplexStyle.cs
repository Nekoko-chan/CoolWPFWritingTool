    ...
    public class ComplexStyles : INotifyPropertyChanged
    {
        ...
        public void Export()
        {
            var dlg = new SaveFileDialog
            {
                ...
                InitialDirectory = Settings.Default.DefaultFolder,
        ...
        public static ComplexStyles Import()
        {
        ...
        public void CheckAndUpdateFonts()
        {
            ...
            {
                complexStyle.FontFamily = complexStyle.FontFamily.GetFontFamily(new ObservableCollection<FontFamily>(Utilities.PossibleFonts.Select(elem=>elem.Family)));
            }
        }
